...
DataX.prototype.dot=function(a,b){b=!0===b||1===b;var d=a.split("."),c=d.length-1,e=null,f=null;if(0===c)e=window,f=d[0];else{e=window[d[0]];f=d[c];b&&"undefined"===typeof e&&(e=window[d[0]]={});for(var g=1;g<c;g++)e=e[d[g]],b&&"undefined"===typeof e&&(e=e[d[g]]={})}b&&"undefined"===typeof e[f]&&(e[f]={});return{obj:e,key:f}};DataX.prototype.enter=function(a){a=a||window.event;return 13===(a.charCode?a.charCode:a.keyCode)?!0:!1};
DataX.prototype.set=function(a,b,d,c){if("undefined"!==typeof b)try{var e=-1===a.indexOf(".")?"window."+a:a,f=this.dot(e,!0);f.obj[f.key]=b}catch(g){console.log("Error setting value."+g)}if(c||this.isReady)if(b=this.getByAttr(document,'[data-x-bindto="'+a+'"]'),"undefined"===typeof b||0===b.length)console.log("no binds for "+a);else for(a=0,c=b.length;a<c;a++){if(e=b[a],e!==d){var h=e.getAttribute("data-x-bindfn"),m=this.refId;if(-1!==h.indexOf("_view_"))var l=e.getAttribute("data-x-id"),h=h.replace("_view_",
l);else l=null;f=this.dot(h);"undefined"===typeof f.obj[f.key]?console.log(h+" does not exist"):(console.log("bindfn="+h),f=f.obj[f.key](),m=this.refId-m,0<m&&console.log("numRefs = "+m),m=this.createElement(f),null!==l&&m.setAttribute("data-x-id",l),e.hasAttribute("data-x-render")?(f=e.getAttribute("data-x-render"),f=this.dot(f),f.obj[f.key](e,m)):e.parentNode.replaceChild(m,e))}}else this.queueSet.push([a,b,d])};
DataX.prototype.setItem=function(a,b,d){var c=this.dot(a);b=b.toString();"undefined"!==typeof d&&(c.obj[c.key][b]=d);a=this.getByAttr(document,'[data-x-bindto="'+a+'"]');d=a.length;for(c=0;c<d;c++){for(var e=a[c],f=null,g=e.childNodes,h=0,m=g.length;h<m;h++){var l=g[h];if(1===l.nodeType&&l.hasAttribute("data-x-index")&&l.getAttribute("data-x-index")===b){f=l;break}}null!==f&&(f=e.getAttribute("data-x-bindfn"),f=this.dot(f),f=f.obj[f.key](b).trim(),f=this.createElement(f),e.replaceChild(f,l))}};
...
DataX.prototype.getByAttrFB=function(a,b){var d=b.indexOf("["),c=b.indexOf("]",d),e=0===d?"*":b.substring(0,d),f=b.indexOf("=");if(-1<f){var d=b.substring(d+1,f),g=b.substring(f+1,c),c=g.charAt(0);if('"'===c||"'"===c)g=g.substring(1,g.length-1)}else d=b.substring(d+1,c);for(var c=[],e=a.getElementsByTagName(e),h=0,m=e.length;h<m;h++){var l=e[h].getAttribute(d);null!==l&&""!==l&&(-1!==f&&l!=g||c.push(e[h]))}return c};
...
if(""===e||"null"===e)h=null;else{var h=this.dot(e),h=h.obj[h.key];h&&(h._ctrl_=e)}var m=c.hasAttribute("id")?c.getAttribute("id"):c.tagName;""===e&&(e="null");e="new "+f+'("'+m+'", '+e+", true) ";try{var l=new g(c,h,!0);console.log(e+l.id)}catch(n){console.log("ERROR: "+e),console.log(n)}}for(b=0;b<this.queueSet.length;b++)a=this.queueSet[b],this.set(a[0],a[1],a[2],!0);this.queue=[];this.isReady=!0}};
...
DataX.prototype.htmlDecode=function(a){var b=b={amp:"&","#39":"'",quot:'"',lt:"<",gt:">"};return(a+"").replace(/&(amp|quot|lt|gt|(#)([0-9]*));/g,function(a,c,e,f){return"#"===e?String.fromCharCode(Number(f)):b[c]})};DataX.prototype.namespace=function(a,b){xlog("Creating namespace '"+a+"'");for(var d=window,c=a.split("."),e=c.length-1,f=0;f<e;f++)var g=c[f],d=g in d?d[g]:d[g]={};d[c[f]]="undefined"!==typeof b?b:{}};
DataX.prototype.ref=function(a){var b="R"+this.refId++ +"_";this.ids[b]=a;return"dataX.ids."+b};DataX.prototype.refCleanup=function(){null===this.refCleanupTimeout&&(this.refCleanupTimeout=setTimeout(this.refCleanupNow,this.refCleanupRate))};DataX.prototype.refCleanupNow=function(){clearTimeout(this.refCleanupTimeout);var a={};document.documentElement.innerHTML.replace(/dataX\.ids\.(R[0-9]*_)/g,function(b,d){a[d]=this.ids[d]});this.ids=a;this.refCleanupTimeout=null};
DataX.prototype.item=function(a){return a.replace(/\[([0-9]*)\]/g,".$1")};DataX.prototype.instance=function(a){this.inst.push(a);return"dataX.inst."+(this.inst.length-1)};DataX.prototype.loadLanguage=function(a,b){if("undefined"!==typeof this.lang[a]){var d=this.lang[a];for(locale in d)if("undefined"===typeof b[locale])b[locale]=d[locale];else for(key in d[locale])b[locale][key]=d[locale][key]}};
DataX.setLocale=function(a){this.locale=a;for(var b=this.getByAttr(document,"[data-x-id]"),d=0,c=b.length;d<c;d++){var e=b[d],f=e.getAttribute("data-x-id");console.log("refId="+f);f=this.dot(f);f=f.obj[f.key];e=this.getByAttr(e,"[data-x-msg]");j=0;for(jlen=e.length;j<jlen;j++)for(var g=e[j].getAttribute("data-x-msg").split(","),h=0,m=g.length;h<m;h++){var l=g[h].split(":");2===l.length?e[j].innerHTML=f.content(a,l[0],l[1]):3===l.length&&e[j].setAttribute(l[1],f.content(a,l[0],l[2]))}}};
...
ParseDataX.prototype.parseViews=function(a){xlog("Running parseViews");for(var b=dataX.getByAttr(a,"[data-x-view]"),d=b.length-1;-1<d;d--)new ViewBuilder(b[d]);a.getAttribute?(b=a.getAttribute("data-x-view"),null!==b&&""!==b?new ViewBuilder(a):this.findOrphans(a)):this.findOrphans(a)};
