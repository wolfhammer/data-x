String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var xDebug=!0;function xlog(a){xDebug&&console.log("data-x: "+a)}function DataX(){if("undefined"===typeof window.dataX)return this.locale="eng",this.getByAttr="querySelectorAll"in document?this.getByAttrQS:this.getByAttrFB,this.queueSet=[],this.isReady=!1,this.ids={},this.refId=0,this.refCleanupTimeout=null,this.refCleanupRate=1E3,this.inst=[],this.readyQueue=[],this.lang={},this}
